...
<nav class="navbar2 navbar-inverse">
  ...
  <div class="contain">
    ...
    <br>
      <ul class="nav nav-pills nav-stacked">
        <li role="presentation" class="active"><a href="AddBarangay.php">Add Barangay</a></li>
        <li role="presentation"><a href="Confirmrequests.php">Confirm requests</a></li>
    ...
    <div class="addbar">
        <div class="form-group">
          <br>
          <label for="exampleInputName2">Barangay</label>
  ...
  <div class="listbar">
      <!--lists of barangays-->
      <br>
      <h2 class=>Lists Of Barangays</h2>
        <ul class="list-group">
