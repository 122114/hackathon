...
<nav class="navbar2 navbar-inverse">
  <div class="container-fluid">
    <div>
      <ul class="nav navbar-nav">
        ...
        <li><a href="#">Event</a></li>
         <li class="active"><a href="sponsordonate.php">Donate</a></li> 
      </ul>
    </div>
  </div>
</nav>
    ...
    <div style="padding-top:20px;">
       <label for="brgylist" style = "color: black;">Barangay list:</label>
       <select name="cbobrgylist" id="brgylist">
          <option value="#">Select Barangay</option>
       </select>
		</div>
     <!--punanan nlang neg function-->
     <div style="padding-left:25px;">
        <img src="denrprofile.jpg" style="width:200px;"/><label style="color:black;;">DENR Bank Account: adcd1234</label>
       <h3>Admin Account: DENR</h3>
        <input type="submit" value="Confirm Donation" name="btnconfirm"/>
         <input type="submit" value="Cancel Donation" name="btncancel"/>
     </div>
	</div>
